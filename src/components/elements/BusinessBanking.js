        ...
        return (
            <div>
                <ul className="alert-btns">
                    <li><a
                        className={ currentBusinessMeta.business_banking == 'option 1' ? 'active' : '' }
                        href="" onClick={(e) => this.onClickOption(e, 'option 1')}>Option 1</a></li>
                    <li><a
                        className={ currentBusinessMeta.business_banking == 'option 2' ? 'active' : '' }
