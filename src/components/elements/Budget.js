        ...
        return (
            ...
            <div>
                <ul className="alert-btns">
                    <li><a
                        className={ currentBusinessMeta.budget == 'yes' ? 'active' : '' }
                        href="" onClick={(e) => this.onClickOption(e, 'yes')}>Yes</a></li>
                    <li>
                        <select onChange={(e) => this.onChangeSelect(e)} value={ currentBusinessMeta.budget_option}>
