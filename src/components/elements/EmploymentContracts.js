...
class EmploymentContracts extends Component {
    ...
    onChangeSelect(e) {
        ...
        this.props.saveBusinessOptionFormRequest({
                ...
                business_meta: {
                    employment_contracts_option: e.target.value
                }
            }
        ).then(
            (response) => {
        ...
        return (
            <div>
                <ul className="alert-btns">
                    <li><a
                        className={ currentBusinessMeta.employment_contracts == 'yes' ? 'active' : '' }
                        href="" onClick={(e) => this.onClickOption(e, 'yes')}>Yes</a></li>
                    <li>
                        <select onChange={(e) => this.onChangeSelect(e)} value={ currentBusinessMeta.employment_contracts_option}>
