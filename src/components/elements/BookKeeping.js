...
class BookKeeping extends Component {
    ...
    onChangeSelect(e) {
        ...
        saveBusinessOption(this, {
                ...
                business_meta: {
                    book_keeping_option: e.target.value
                }
            }
        );
    }
        ...
        return (
            <div>
                <ul className="alert-btns">
                    <li><a
                        className={ currentBusinessMeta.book_keeping == 'yes' ? 'active' : '' }
                        href="" onClick={(e) => this.onClickOption(e, 'yes')}>Yes</a></li>
                    <li>
                        <select onChange={(e) => this.onChangeSelect(e)} value={ currentBusinessMeta.book_keeping_option}>
