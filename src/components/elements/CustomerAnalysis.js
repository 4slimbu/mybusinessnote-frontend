...
class CustomerAnalysis extends Component {
    ...
    onChangeSelect(e) {
        ...
        this.props.saveBusinessOptionFormRequest({
                ...
                business_meta: {
                    customer_analysis_option: e.target.value
                }
            }
        ).then(
            (response) => {
        ...
        return (
            <div>
                <ul className="alert-btns">
                    <li><a
                        className={ currentBusinessMeta.customer_analysis == 'yes' ? 'active' : '' }
                        href="" onClick={(e) => this.onClickOption(e, 'yes')}>Yes</a></li>
                    <li>
                        <select onChange={(e) => this.onChangeSelect(e)} value={ currentBusinessMeta.customer_analysis_option}>
