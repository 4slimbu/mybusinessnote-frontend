...
class SocialMediaExecution extends Component {
    ...
    onChangeSelect(e) {
        ...
        this.props.saveBusinessOptionFormRequest({
                ...
                business_meta: {
                    social_media_execution_option: e.target.value
                }
            }
        ).then(
            (response) => {
        ...
        return (
            <div>
                <ul className="alert-btns">
                    <li><a
                        className={ currentBusinessMeta.social_media_execution == 'yes' ? 'active' : '' }
                        href="" onClick={(e) => this.onClickOption(e, 'yes')}>Yes</a></li>
                    <li>
                        <select onChange={(e) => this.onChangeSelect(e)} value={ currentBusinessMeta.social_media_execution_option}>
