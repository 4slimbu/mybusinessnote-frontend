...
class HrPolicy extends Component {
    ...
    onChangeSelect(e) {
        ...
        saveBusinessOption(this, {
                ...
                business_meta: {
                    hr_policy_option: e.target.value
                }
            }
        );
    }
        ...
        return (
            ...
            <div>
                <ul className="alert-btns">
                    <li><a
                        className={ currentBusinessMeta.hr_policy == 'yes' ? 'active' : '' }
                        href="" onClick={(e) => this.onClickOption(e, 'yes')}>Yes</a></li>
                    <li>
                        <select onChange={(e) => this.onChangeSelect(e)} value={ currentBusinessMeta.hr_policy_option}>
