...
class OfficeSpace extends Component {
    ...
    onChangeSelect(e) {
        ...
        this.props.saveBusinessOptionFormRequest({
                ...
                business_meta: {
                    office_space_option: e.target.value
                }
            }
        ).then(
            (response) => {
        ...
        return (
            <div>
                <ul className="alert-btns">
                    <li><a
                        className={ currentBusinessMeta.office_space == 'yes' ? 'active' : '' }
                        href="" onClick={(e) => this.onClickOption(e, 'yes')}>Yes</a></li>
                    <li>
                        <select onChange={(e) => this.onChangeSelect(e)} value={ currentBusinessMeta.office_space_option}>
