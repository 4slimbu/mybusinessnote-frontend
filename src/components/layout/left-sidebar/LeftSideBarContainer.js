...
class LeftSideBarContainer extends Component {
  ...
  render() {
    ...
    const completed_percent = appStatus.currentLevel.completed_percent
      ? appStatus.currentLevel.completed_percent
      : 0;
        ...
        <div>
          <section className="hidden-xs left-sec bg-navy">
            <Link to="/" className="site-branding">
              <img src={`${publicUrl()}/assets/images/logo-white.png`} alt="" />
            </Link>
            <h3 className="tagline-head">
              Let your <br />
              journey begin
            </h3>
