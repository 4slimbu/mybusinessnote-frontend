...
export const SET_SHOW_COMPLETED_PAGE = "SET_SHOW_COMPLETED_PAGE";
export const SET_COMPLETED_STATUS = "SET_COMPLETED_STATUS";
export const TRACK_AFFILIATE_LINK_CLICK = "TRACK_AFFILIATE_LINK_CLICK";
...
export const SET_APP_STATUS_REDUCER = "SET_APP_STATUS_REDUCER";
